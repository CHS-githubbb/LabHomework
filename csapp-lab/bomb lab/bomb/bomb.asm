...
0000000000400efc <phase_2>:
  ...
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>        ;save 6 numbers in M[%rsi] ~ M[%rsi + 20]
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                      ;compare M[%rsi] with 1 (*reverse order)
  400f0e:	74 20                	je     400f30 <phase_2+0x34>            ;jump to f30 if equal else explode (first number is 1)
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax                  ;%rax = M[%rsi]
  400f1a:	01 c0                	add    %eax,%eax                        ;%rax = M[%rsi] + M[%rsi]
  400f1c:	39 03                	cmp    %eax,(%rbx)                      ;compare M[%rsi + 4] with %rax
  400f1e:	74 05                	je     400f25 <phase_2+0x29>            ;jump to f25 if equal else explode (2 == 2, second number is 2)
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx                        ;%rbx = %rsi + 8
  400f29:	48 39 eb             	cmp    %rbp,%rbx                        ;compare %rbx with %rbp
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>            ;jump to f17 if not equal (now we are in a loop until %rbx equals %rbp)
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx                   ;%rbx = %rsi + 4
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp                  ;%rbp = %rsi + 24
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>            ;jump to f17
...
0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp                       ;make a stack, size 24
  ...
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>     ;input a string into %rdi with the format in %rsi (%d %d), x and y save in %rdx and %rxc
  400f60:	83 f8 01             	cmp    $0x1,%eax                        ;compare %rax with 1 (I think %rax is probably the return value of sscanf)
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>            ;jump to f6a if greater else explode
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)                   ;compare M[%rsp + 8] wih 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>            ;jump to fad(explode) if greater (so x is le 7)
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax                   ;%rax = M[%rsp + 8]
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)               ;jump to somewhere depends on x (check the value using (gdb) x addr)
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                       ;jump here if x = 0, then y should be 207
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>            ;jump to fbe
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax                   ;compare %rax with y
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>            ;if equal jump to fc9 else explode
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq   

0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp                        ;suppose a in %rdx, b in %rsi, x in %rdi, t in %rax, m in %rcx
  400fd2:	89 d0                	mov    %edx,%eax                        ;
  400fd4:	29 f0                	sub    %esi,%eax                        ;t = a - b
  400fd6:	89 c1                	mov    %eax,%ecx                        ;
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                       ;m = t >> 31
  400fdb:	01 c8                	add    %ecx,%eax                        ;t += m
  400fdd:	d1 f8                	sar    %eax                             ;t >>= 1 (right shift with default 1)
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx               ;m = t + b
  400fe2:	39 f9                	cmp    %edi,%ecx                        ;compare m with x
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>              ;jump to ff2 if less or equal
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx                  ;a - m - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>                   ;call func4(a, b, x)
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>              ;jump to 1007(exit, we need to find a way to go here)
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                        ;t = 0
  400ff7:	39 f9                	cmp    %edi,%ecx                        ;compare m with x
  400ff9:	7d 0c                	jge    401007 <func4+0x39>              ;jump to 1007 if greater or equal
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi                   ;b = m + 1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>                   ;call func4(a, b, x)
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  401007:	48 83 c4 08          	add    $0x8,%rsp
  40100b:	c3                   	retq   

000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp                       ;init stack
  ...
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>     ;x in %rdx, y in %rcx, format: "%d %d"
  401029:	83 f8 02             	cmp    $0x2,%eax                        ;2 input expected
  40102c:	75 07                	jne    401035 <phase_4+0x29>            ;explode if not equal
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)                   ;compare x with 14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>            ;jump to 03a if below or equal, else explode
  ...
  401048:	e8 81 ff ff ff       	callq  400fce <func4>                   ;%rdx, %rsi and %rdi will be the 3 parameters of func4
  40104d:	85 c0                	test   %eax,%eax                        ;test %rax %rax will give whether jne will give whether %rax is 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>            ;if not equal then explode
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)                   ;compare y with 0
  401056:	74 05                	je     40105d <phase_4+0x51>            ;jump to 05d if equal else explode
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx                        ;%rbx = %rdi (the input)
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                    ;somthing like stack protection check whatever
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)                  ;M[%rsp + 24] = %rax
  401078:	31 c0                	xor    %eax,%eax                        ;%rax = 0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>           ;save length of input in %rax
  40107f:	83 f8 06             	cmp    $0x6,%eax                        ;compare %rax with 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>            ;jump to 0d2 if equal else explode (so input must have a length of 6)
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx               ;%ecx = M[%rbx + %rax] (byte to long word, filled with 0s)
  40108f:	88 0c 24             	mov    %cl,(%rsp)                       ;M[%rsp] = lower 8 bits of %rcx 
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                      ;%rdx = lower 8 bits of %rcx (save lower 8 bits)
  401096:	83 e2 0f             	and    $0xf,%edx                        ;%edx = %edx & 1111b
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx              ;%rdx = %rdx + 0x4024b0 ("maduiersnfotvbylSo you think you can stop the bomb with ctrl-c, do you?")
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)            ;M[%rsp + %rax + 16] (accumulate one char each loop)
  4010a4:	48 83 c0 01          	add    $0x1,%rax                        ;%rax = %rax + 1
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                        ;compare %rax with 6
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>            ;if not equal jump to 08b
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)                  ;M[%rsp + 22] = 0 (end character)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi                   ;%rsi = 0x40245e ("flyers")
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi                  ;%rdi = %rsp + 16
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>       ;check if %rdi equals to %rsi
  4010c2:	85 c0                	test   %eax,%eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>            ;jump to d9 if %rax equals to 0 else explode
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax                        ;%rax = 0
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>            ;jump to 08b
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax                  ;%rax = M[%rsp + 24]
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax                    ;stack protection check
  4010e5:	00 00 
  4010e7:	74 05                	je     4010ee <phase_5+0x8c>            ;jump to ee if safe else trigger stack fail
...
00000000004010f4 <phase_6>:
  ...
  4010fa:	55                   	push   %rbp
  4010fb:	53                   	push   %rbx
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp                       ;init stack, size 80
  401100:	49 89 e5             	mov    %rsp,%r13                        ;%r13 = %rsp
  401103:	48 89 e6             	mov    %rsp,%rsi                        ;%rsi = %rsp
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>        ;read six numbers in [%rsi, %rsi + 20]
  40110b:	49 89 e6             	mov    %rsp,%r14                        ;%r14 = %rsp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                       ;%r12d = 0
  401114:	4c 89 ed             	mov    %r13,%rbp                        ;%rbp = %r13
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax                   ;%rax = M[%r13] = M[%rsi]
  40111b:	83 e8 01             	sub    $0x1,%eax                        ;%rax = %rax - 1
  40111e:	83 f8 05             	cmp    $0x5,%eax                        ;compare %rax with 5
  401121:	76 05                	jbe    401128 <phase_6+0x34>            ;jump to 1128 if below or equal else explode
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d                       ;%r12d = %r12d + 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                       ;compare %r12d with 6
  401130:	74 21                	je     401153 <phase_6+0x5f>            ;jump to 1153 if eaqual
  401132:	44 89 e3             	mov    %r12d,%ebx                       ;%rbx = %r12d
  401135:	48 63 c3             	movslq %ebx,%rax                        ;%rax = %rbx
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax               ;%rax = M[%rsp + %rax * 4]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)                   ;compare M[%rbp] with %rax
  40113e:	75 05                	jne    401145 <phase_6+0x51>            ;jump to 1145 if not equal else explode
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                        ;%rbx = %rbx + 1
  401148:	83 fb 05             	cmp    $0x5,%ebx                        ;compare %rbx with 5
  40114b:	7e e8                	jle    401135 <phase_6+0x41>            ;jump to 1135 if less or equal
  40114d:	49 83 c5 04          	add    $0x4,%r13                        ;%r13 = %r13 + 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20>            ;jump to 1114
  ...
  401162:	2b 10                	sub    (%rax),%edx                      ;%rdx - = %rdx - M[%rax]
  401164:	89 10                	mov    %edx,(%rax)                      ;M[%rax] = %rdx
  401166:	48 83 c0 04          	add    $0x4,%rax                        ;%rax = %rax + 4
  40116a:	48 39 f0             	cmp    %rsi,%rax                        ;compare %rax with %rsi
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>            ;jump to 1160 if not equal
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                        ;%rsi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>            ;jump to 1197
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx                   ;%rdx = M[%rdx + 8]
  40117a:	83 c0 01             	add    $0x1,%eax                        ;%rax = %rax + 1
  40117d:	39 c8                	cmp    %ecx,%eax                        ;compare %rax with %rcx
  40117f:	75 f5                	jne    401176 <phase_6+0x82>            ;jump to 1176 if not equal
  401181:	eb 05                	jmp    401188 <phase_6+0x94>            ;jump to 1188
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx                   ;%rdx = 0x6032d0
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)           ;M[%rsp + %rsi * 2 + 32] = %rdx
  40118d:	48 83 c6 04          	add    $0x4,%rsi                        ;%rsi = %rsi + 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                       ;compare %rsi with 24
  401195:	74 14                	je     4011ab <phase_6+0xb7>            ;jump to 11ab if equal
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx               ;%rcx = M[%rsp + %rsi * 1]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                        ;compare %rcx with 1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>            ;jump to 1183 if less or equal
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                        ;%rax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx                   ;%rdx = 0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>            ;jump to 1176
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx                  ;%rbx = M[%rsp + 32]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax                  ;%rax = M[%rsp + 40]
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi                  ;%rsi = M[%rsp + 80]
  ...
  4011c8:	48 39 f0             	cmp    %rsi,%rax                        ;compare %rax with %rsi
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>            ;jump to 11d2 if equal
  4011cd:	48 89 d1             	mov    %rdx,%rcx                        ;%rcx = %rdx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>            ;jump to 11bd
  ...
  4011e5:	39 03                	cmp    %eax,(%rbx)                      ;compare M[%rbx] with %rax
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>            ;jump to 11ee if greater or equal else explode
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx                   ;%rbx = M[%rbx + 8]
  4011f2:	83 ed 01             	sub    $0x1,%ebp                        ;%rbp = %rbp - 1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>            ;jump to 11df if not equal
  4011f7:	48 83 c4 50          	add    $0x50,%rsp                       ;%rsp = %rsp + 80
  4011fb:	5b                   	pop    %rbx
  4011fc:	5d                   	pop    %rbp
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp                 ;init stack, size 24                  
  ...
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi             ;%esi = 0x4025c3 (format: "%d %d %d %d %d %d")
...
000000000040149e <read_line>:                                     ;read into %rdi
...
00000000004015c4 <phase_defused>:
  4015c4:	48 83 ec 78          	sub    $0x78,%rsp                         ;init stack, size 120
  4015c8:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                      ;stack protection
  4015cf:	00 00 
  4015d1:	48 89 44 24 68       	mov    %rax,0x68(%rsp)
  4015d6:	31 c0                	xor    %eax,%eax
  4015d8:	83 3d 81 21 20 00 06 	cmpl   $0x6,0x202181(%rip)        # 603760 <num_input_strings> count num of input strings, exit phase_defused if does not equal 6
  ...
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi                     ;0x603870 <input_strings+240> "" (I must do something wrong)
  4015fa:	e8 f1 f5 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  4015ff:	83 f8 03             	cmp    $0x3,%eax                          ;compare %rax with 3
  401602:	75 31                	jne    401635 <phase_defused+0x71>        ;jump to 1635 if not equal
  401604:	be 22 26 40 00       	mov    $0x402622,%esi                     ;%rsi = 0x402622 ("DrEvil")
  401609:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi                    ;%rdi = M[%rsp + 16]
  40160e:	e8 25 fd ff ff       	callq  401338 <strings_not_equal>
  401613:	85 c0                	test   %eax,%eax
  401615:	75 1e                	jne    401635 <phase_defused+0x71>        ;jump to 1635 if %rax != 0
  401617:	bf f8 24 40 00       	mov    $0x4024f8,%edi                     ;%rdi = 0x4024f8 ("Curses, you've found the secret phase!")
  ...
  40163f:	48 8b 44 24 68       	mov    0x68(%rsp),%rax                    ;%rax = M[%rsp + 104]
  401644:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax                      ;protection check
  40164b:	00 00 
